...
@MainActor public final class NativePasskeyAuthoriser: NSObject, MemberPasskeyAuthorising, ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding {
    ...
    public func authorizationController(controller: ASAuthorizationController, didCompleteWithAuthorization authorization: ASAuthorization) {
        ...
        case (.assertion, let credential as ASAuthorizationPlatformPublicKeyCredentialAssertion), (.statement, let credential as ASAuthorizationPlatformPublicKeyCredentialAssertion), (.decision, let credential as ASAuthorizationPlatformPublicKeyCredentialAssertion), (.withdrawal, let credential as ASAuthorizationPlatformPublicKeyCredentialAssertion), (.leave, let credential as ASAuthorizationPlatformPublicKeyCredentialAssertion):
