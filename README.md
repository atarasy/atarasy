...
- **Two protections of the four, and nothing that loosens.** The cooling window (§16.5) and the daily ceiling (§16.3) can be set here; co-signers and the categories needing a second signature cannot, and neither can any change that loosens what is already set. A loosening needs everyone the person named, and this screen says who they are rather than pretending the move does not exist.
