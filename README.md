...
- **Lets a person set their own protections** (§16). A cooling window is recorded as a mandate, signed the same way a decided set is, and while it is open a decided offer waits rather than settling and can be taken back (§16.5). Clause 47's asymmetry is on the screen: what tightens is the person's alone, and this screen offers nothing that loosens.
...
- **Every protection but the cooling window.** No daily ceiling, no co-signers, no categories needing a second signature, and so nothing that loosens.
